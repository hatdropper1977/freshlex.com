...
![Not Secure]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/00_Not_Secure.png)
...
![Click Hosted Zones]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/03_Click_Hosted_Zones.png)

Click "Create Hosted Zone."

![Click Create Hosted Zone]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/04_Click_Create_Hosted_Zone.png)
...
![Create A Hosted Zone]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/05_Create_A_Hosted_Zone.png)
...
![Find The Name Servers]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/06_Find_The_Name_Servers.png)
...
![Point Go Daddy To Amazon]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/07_Point_Go_Daddy_To_Amazon.png)

Under the Nameservers box for your domain, you will see a button labeled "Change."  Click that button.

![DNS Splash ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/08_DNS_Splash.png)

Now enter the four name servers you copied from AWS.

![Add AWS Name Servers]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/09_Add_AWS_Name_Servers.png)

Oops!  GoDaddy does not like the trailing "dot."  Delete the Dots and click save.

![Fix Error ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/10_Fix_Error.png)
...
![Find S3 Console]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/11_Find_S3_Console.png)

Click "+ Create Bucket"

![Click Create Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/12_Click_Create_Bucket.png)
...
![Create Bucket ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/13_Create_Bucket.png)

Click next to skip the "Versioning/ Tags/ Server access logging" screen.

![Create Bucket Click Next]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/14_Create_Bucket_Click_Next.png)

Since this is your logs bucket, you will give S3 permission to use it.

![Allow Log Delivery Access]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/15_Allow_Log_Delivery_Access.png)

Review and click "Create Bucket."

![Click Create Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/16_Click_Create_Bucket.png)
...
![Create WWW Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/17_Create_WWW_Bucket.png)

On the second screen, click "Server Access Logging."

![Configure Log Target For WWW Bucket  ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/18_Configure_Log_Target_For_WWW_Bucket.png)
...
![Enable Logging WWW]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/19_Enable_Logging_WWW.png)

Grant public read access to this bucket (since it is for a public website).

![Grant Public Access]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/20_Grant_Public_Access.png)
...
![Name Naked Domain Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/21_Name_Naked_Domain_Bucket.png)
...
![Enable Logging For Naked Domain Logging ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/22_Enable_Logging_For_Naked_Domain_Logging.png)

Grant the public read access to the bucket.

![Grant Public Access For Naked Domain Bucket ]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/23_Grant_Public_Access_For_Naked_Domain_Bucket.png)
...
![Select WWW Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/24_Select_WWW_Bucket.png)

Click the "Properties" tab, and then "Static website hosting."

![Select Static Hosting]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/25_Select_Static_Hosting.png)
...
![Enable Website Hosting]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/26_Enable_Website_Hosting.png)

Now click the "Permissions" tab.  You will see the bucket policy editor.

![Open Policy Editor]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/27_Open_Policy_Editor.png)
...
![Edit Policy]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/28_Edit_Policy.png)

S3 barks.  You can ignore it.  You want the public to ***GetObject***, i.e. see your website.

![Confirm Edit]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/29_Confirm_Edit.png)
...
![Select Naked Domain Bucket]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/30_Select_Naked_Domain_Bucket.png)

Click "Properties" and then "Static website hosting."

![Select Configure Static Website Hosting]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/31_Select_Configure_Static_Website_Hosting.png)
...
![Configure Naked Redirection]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/32_Configure_Naked_Redirection.png)
...
![Open Certificate Manager]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/33_Open_Certificate_Manager.png)

Click through the splash screen and select "Request a Certificate."

![Click Request Certificate]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/34_Click_Request_Certificate.png)

Select "Request Public Certificate" and click "Request a certificate" once more.

![Select Public Certificate]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/35_Select_Public_Certificate.png)
...
![Add WWW And Naked Domain Names]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/36_Add_WWW_And_Naked_Domain_Names.png)

***Step 2***, select "DNS validation" and then "Review."

![Select DNS Validation]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/37_Select_DNS_Validation.png)
...
![Review Config]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/38_Review_Config.png)

The screen reads "pending validation" but nothing will happen unless you perform the next few steps.  First, click "Continue."

![Select Continue]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/39_Select_Continue.png)

Now, expand the triangle for your domain name.

![Expand Triangle]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/40_Expand_Triangle.png)
...
![Create Record In Route 53]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/41_Create_Record_In_Route_53.png)

You will see a DNS record to prove that you own your site name.  It will look like a bunch of gibberish.  Click create.

![View Validation Record]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/42_View_Validation_Record.png)
...
![Success Splash]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/43_Success_Splash.png)

If you're curious, you can look at Route 53, where you will see the two validation records that ACM configured.

![Validation Records In Route 53]({filename}/images/How_To_Configure_S3_Website_To_Use_Https_Part_1/44_Validation_Records_In_Route_53.png)
